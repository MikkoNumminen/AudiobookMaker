...
- **Running version shown in the title bar** -- `AudiobookMaker v3.6.1`
...
**Download:** [AudiobookMaker v3.6.1](https://github.com/MikkoNumminen/AudiobookMaker/releases/tag/v3.6.1)

**How to install:**
1. Download `AudiobookMaker-Setup-3.6.1.exe`
