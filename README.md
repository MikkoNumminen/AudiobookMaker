...
The skills committed under [`.claude/skills/`](.claude/skills/) are
catalogued in [docs/skill_catalog.md](docs/skill_catalog.md), with body
sizes, usage evidence, and the keep/trim verdict from the last audit. A
pre-commit check fails if that table drifts from the directory.
