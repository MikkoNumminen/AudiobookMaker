...
- **Running version shown in the title bar** -- `AudiobookMaker v3.5.1`
...
**Download:** [AudiobookMaker v3.5.1](https://github.com/MikkoNumminen/AudiobookMaker/releases/tag/v3.5.1)

**How to install:**
1. Download `AudiobookMaker-Setup-3.5.1.exe`
