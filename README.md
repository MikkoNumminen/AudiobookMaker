...
Without this, your local commits skip the project's guardrails — they will still land but they will break things (stale `docs/CLI.md`, untested code).
...
The project mascot is a goat 🐐 — appears in the application icon and is the canonical brand on release notes and social posts.
