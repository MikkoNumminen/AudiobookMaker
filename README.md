...
- **Running version shown in the title bar** -- `AudiobookMaker v3.3.0`
...
**Download:** [AudiobookMaker v3.3.0](https://github.com/MikkoNumminen/AudiobookMaker/releases/tag/v3.3.0)

**How to install:**
1. Download `AudiobookMaker-Setup-3.3.0.exe`
