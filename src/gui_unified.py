...
_STRINGS = {
    "fi": {
        ...
        "chatterbox_venv_missing": "Chatterbox-moottoria ei ole asennettu. Asenna se Asetukset-paneelin \"Asenna moottoreita…\" -painikkeesta.",
    ...
    "en": {
        ...
        "chatterbox_venv_missing": "Chatterbox engine is not installed. Install it from the Settings panel's \"Install engines…\" button.",
